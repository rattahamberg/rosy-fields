...
const checks = [
  ...
  ["ledger indexes", `SELECT indexname FROM pg_indexes WHERE schemaname='public' AND indexname IN ('expense_household_active_sorted_idx', 'expense_paid_by_idx', 'expense_created_by_idx', 'expense_split_user_id_idx', 'settlement_household_active_sorted_idx', 'settlement_from_user_idx', 'settlement_to_user_idx', 'settlement_created_by_idx', 'household_audit_log_household_idx') ORDER BY indexname`],
