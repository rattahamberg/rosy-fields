...
// Per-detail-page error boundary: a throw inside the household-detail page
// surfaces here without unmounting the admin shell + nav.
export default function HouseholdDetailError({
  error,
  unstable_retry,
}: {
  ...
  useEffect(() => {
    console.error("admin household-detail error", error);
  }, [error]);
